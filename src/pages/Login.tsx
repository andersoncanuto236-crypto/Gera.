    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#0D171D]">
      ...
      <div className="max-w-md w-full glass-panel rounded-[48px] p-12 shadow-2xl animate-fade-in-up relative z-10 text-center">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter mb-2">Gera<span className="text-brand-500">.</span></h1>
          <p className="text-slate-400 font-medium text-sm px-4 leading-relaxed">
            Entre para acessar sua central de conteúdo.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          ...
          >
            {loading ? <i className="fas fa-circle-notch fa-spin text-brand-500 text-lg"></i> : 'Entrar'}
          </button>
        </form>

        <div className="mt-6 flex flex-col gap-3 text-[10px] uppercase tracking-widest font-bold text-slate-500">
          <button onClick={handlePasswordReset} className="hover:text-brand-400 transition-colors">
            Esqueci minha senha
          </button>
